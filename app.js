const subjectPriorities = {
    ...
    'фізик': 1, 'хімі': 1, // Перенесено сюди
    'англійськ': 1, 'нім': 1, 'іноземн': 1, 
    'укр. мов': 1, 'мов': 1, // Мова — це завжди важко

    // 2 - СЕРЕДНЯ СКЛАДНІСТЬ (Гуманітарні та природничі науки)
    // Можуть бути спарені, якщо це необхідно (напр. 2 історії підряд)
    'літ': 2, 'історі': 2, 'біолог': 2, 'географ': 2, 
    'право': 2, 'громад': 2, 'етик': 2, 'захист': 2, 
    'природ': 2, 'інформ': 2, 'stem': 2, 'стеm': 2, // STEM часто потребує 2 уроки підряд

    // 3 - НИЖЧА СКЛАДНІСТЬ (Мистецтво, спорт, праця)
    // Найкраще підходять для спарювання (2 уроки праці/фізкультури підряд — норма)
    'фізкульт': 3, 'фізичн': 3,
    'технолог': 3, 'трудов': 3, 
